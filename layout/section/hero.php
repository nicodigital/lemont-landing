<section class="hero">
  ...
  $img->set('class', 'rellax xg:w-[27%] mx-auto opacity-[.25]');
  ...
  <div class="absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-90% xg:w-33% z-50">
    ...
    <div class="partners flex justify-between text-small xg:text-body text-white translate-y-[6rem] xg:translate-y-[6rem] font-light">
